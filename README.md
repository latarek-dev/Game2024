Simple game where players need to find keywords in real life and then enter them into app. This app was only to count these points. Game has built in ranking system.
